...
public class BomberMan {
    private static final int IMG_COLUMN = 3;
    private static final int IMG_ROW = 4;
    ...
    public BomberMan(StartGame gameframe, int man_x, int man_y) {
        ...
        ImageIcon ic = new ImageIcon("src/images/bad1.png");		//开始为正面的人物，所以为man3
        image = ic.getImage();
        ...
        try {
            bufimg = ImageIO.read(new File("src/images/bad1.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        moveAnimateThread();
