...
//        PrintMap.print(gameframe,FIRE_IN_ROUTE);
        if (!isFirePlace()) {
            countDown(); //倒计时爆炸
        } else {
            bombRightNow();
    ...
    void cleanBomb(int map_x, int map_y) {
        ...
        //爆炸放火焰
        fire_obj = new Fire(this, fire_set, gameframe, map_x, map_y);
//        new Fire(fire_set, gameframe, map_x + ONE_STEP , map_y + ONE_STEP);
    }
}
